...
func AnimatedPhysicalModel[TColor duit_color.Color, TShape duit_decoration.ShapeBorder[TColor]](attributes *duit_attributes.AnimatedPhysicalModelAttributes[TColor, TShape], id string, child *duit_core.DuitElementModel) *duit_core.DuitElementModel {
