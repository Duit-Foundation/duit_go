...
func TextUiElement[T duit_color.Color](attributes *duit_attributes.TextAttributes[T], id string, controlled bool, action *duit_core.Action) *duit_core.DuitElementModel {
