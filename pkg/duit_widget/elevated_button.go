...
func ElevatedButton[TColor duit_props.Color, TInsets duit_edge_insets.EdgeInsets, TShape duit_decoration.ShapeBorder[TColor], TAction duit_action.Action](attributes *duit_attributes.ElevatedButtonAttributes[TColor, TInsets, TShape, TAction], id string, action *TAction, child *duit_core.DuitElementModel) *duit_core.DuitElementModel {
