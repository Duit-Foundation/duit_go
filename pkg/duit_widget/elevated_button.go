...
func ElevatedButton[TColor duit_props.Color, TInsets duit_props.EdgeInsets, TShape duit_props.ShapeBorder[TColor], TAction duit_action.Action](attributes *duit_attributes.ElevatedButtonAttributes[TColor, TInsets, TShape, TAction], id string, action *TAction, child *duit_core.DuitElementModel) *duit_core.DuitElementModel {
