...
Example:
	...
	SliverAppBar(
		&duit_attributes.SliverAppBarAttributes[duit_props.Color, duit_edge_insets.EdgeInsetsAll, duit_decoration.RoundedRectangleBorder]{
			Floating: true,
			Pinned: true,
