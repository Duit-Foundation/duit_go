...
func GridView[TAction duit_core.Action, TInsets duit_edge_insets.EdgeInsets, U duit_attributes.GridViewAttributes[TInsets]](attributes *U, id string, controlled bool, action *TAction, children []*duit_core.DuitElementModel) *duit_core.DuitElementModel {
