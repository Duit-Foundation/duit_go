...
type TextFieldAttributes[TInsets duit_props.EdgeInsets] struct {
	...
	*ThemeConsumer
	...
	Decoration         *duit_props.InputDecoration[TInsets] `json:"decoration,omitempty"`
}

func (r *TextFieldAttributes[TInsets]) Validate() error {
