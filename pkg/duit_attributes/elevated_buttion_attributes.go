...
type ElevatedButtonAttributes[TColor duit_props.Color, TInsets duit_props.EdgeInsets, TShape duit_props.ShapeBorder[TColor], TAction duit_action.Action] struct {
