...
func TestCheckTweenType(t *testing.T) {
	...
	arr := []any{
		...
		duit_props.SizeTween("size", duit_props.NewSize(10, 20), duit_props.NewSize(20, 40), 1, duit_props.AnimationTriggerOnEnter, duit_props.AnimationMethodForward, false, ""),
		// border
