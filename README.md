...
func Example() []byte {
 ...
 builder.RootFrom(duit_widget.TextUiElement[duit_props.ColorString](&duit_attributes.TextAttributes[duit_props.ColorString]{
  Data: "Example",
  Style: &duit_props.TextStyle[duit_color.ColorString]{
